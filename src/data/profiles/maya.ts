...
export const mayaSpec: ProfileSpec = {
  ...
  cards: [
    { id: 'sofi2', name: BRAND.flatCard, artLabel: '2% EVERYTHING', last4: '4021', art: ['#00A2C7', '#00708A'], balance: 340, limit: 10000, apr: null, program: 'cash', pointValueCents: 1, base: 2, bonus: {}, credits: [], benefits: { purchaseProtectionDays: 90 }, statementCloseDay: 20, isFlatHouseCard: true },
