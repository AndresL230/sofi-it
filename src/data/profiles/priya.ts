...
/** Profile 3 — Priya Nair, Seattle. High income, cash-rich, a dozen subscriptions that keep creeping; big purchases clear, small ones are guilt-free. */
export const priyaSpec: ProfileSpec = {
  ...
  cards: [
    { id: 'sofi2', name: BRAND.flatCard, artLabel: '2% EVERYTHING', last4: '1180', art: ['#00A2C7', '#00708A'], balance: 1120, limit: 15000, apr: null, program: 'cash', pointValueCents: 1, base: 2, bonus: {}, credits: [], benefits: { purchaseProtectionDays: 90 }, statementCloseDay: 20, isFlatHouseCard: true },
