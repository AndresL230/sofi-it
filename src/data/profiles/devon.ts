...
/** Profile 2 — Devon Reyes, Austin. Paycheck-to-paycheck: thin cushion, one card near its limit, dining already over pace. Verdicts skew tight. */
export const devonSpec: ProfileSpec = {
  ...
  cards: [
    { id: 'sofi2', name: BRAND.flatCard, artLabel: '2% EVERYTHING', last4: '3312', art: ['#00A2C7', '#00708A'], balance: 780, limit: 5000, apr: null, program: 'cash', pointValueCents: 1, base: 2, bonus: {}, credits: [], benefits: { purchaseProtectionDays: 90 }, statementCloseDay: 20, isFlatHouseCard: true },
