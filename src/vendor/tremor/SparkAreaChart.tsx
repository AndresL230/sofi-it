  ...
  return (
    <ResponsiveContainer width="100%" height={height}>
      <AreaChart data={data} margin={{ top: 0, right: 0, bottom: 0, left: 0 }}>
        ...
        <Area type="stepAfter" dataKey={category} stroke={color} strokeWidth={2} fill="url(#sparkFill)" isAnimationActive animationBegin={ms} animationDuration={600} dot={false} activeDot={false} />
      </AreaChart>
    </ResponsiveContainer>
  )
}
