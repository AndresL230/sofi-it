...
import { defineCard, CardShell, CardArt, Money, Rich } from './kit'
...
export default defineCard<Props>({ type: 'best_card_row', section: 'Cards & rewards', label: '', condition, select, Component: BestCardRow, samples: [{ query: '$60 dinner' }] })
