...
export default defineCard<Props>({ type: 'subscription_stack', section: 'Recurring', label: '', condition, select, Component: SubscriptionStack, samples: [{ query: '$15/mo Crunchyroll' }] })
