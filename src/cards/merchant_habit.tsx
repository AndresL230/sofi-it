...
import { defineCard, CardShell, Money, Num, useDelay } from './kit'
...
export default defineCard<Props>({ type: 'merchant_habit', section: 'Behavior lens', label: '', condition, select, Component: MerchantHabit, samples: [{ query: '$6 latte' }] })
