...
import { defineCard, CardShell, Money, Num, Badge, useDelay, type CardActions } from './kit'
...
export default defineCard<Props>({ type: 'payday_proximity', section: 'Money context', label: '', condition, select, Component: PaydayProximity, samples: [{ query: '$28 Uber' }] })
