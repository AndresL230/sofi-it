...
export default defineCard<Props>({ type: 'duplicate_check', section: 'Behavior lens', label: '', condition, select, Component: DuplicateCheck, samples: [{ query: '$140 running shoes' }] })
