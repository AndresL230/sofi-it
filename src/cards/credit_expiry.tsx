...
import { defineCard, Money, Num, Caps, useDelay } from './kit'
...
export default defineCard<Props>({ type: 'credit_expiry', section: 'Cards & rewards', label: '', condition, select, Component: CreditExpiry, samples: [{ query: '$60 dinner' }] })
