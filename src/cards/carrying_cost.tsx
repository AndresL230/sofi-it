...
export default defineCard<Props>({ type: 'carrying_cost', column: 'left', section: 'Money context', label: '', condition, select, Component: CarryingCost, samples: [{ query: '$450 monitor' }] })
