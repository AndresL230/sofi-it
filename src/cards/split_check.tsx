...
import { defineCard, Money, NumberFlowGroup, Caps } from './kit'
...
export default defineCard<Props>({ type: 'split_check', section: 'Behavior lens', label: 'interactive', condition, select, Component: SplitCheck, samples: [{ query: '$60 dinner' }] })
