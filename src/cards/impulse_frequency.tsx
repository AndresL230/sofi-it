...
import { defineCard, CardShell, Money, Num } from './kit'
...
export const condition = (ctx: EngineContext) => ctx.q.size !== 'small' && ctx.q.isDiscretionary && ctx.q.frequency !== 'recurring' && ctx.impulse.past.length >= 1
...
export default defineCard<Props>({ type: 'impulse_frequency', section: 'Behavior lens', label: '', condition, select, Component: ImpulseFrequency, samples: [{ query: '$140 running shoes' }] })
