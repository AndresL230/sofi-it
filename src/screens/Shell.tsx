  ...
  return (
    <div className="min-h-screen bg-page">
      <div data-screen="nav" className="sticky top-0 z-20 border-b border-lavender bg-white">
        <div className="mx-auto flex max-w-shell items-center gap-[22px] px-6 py-[13px]">
          ...
          <div className="flex flex-1 gap-5 text-[14px]">
            <span className="border-b-2 border-teal pb-[2px] font-bold text-navy">{BRAND.navSection}</span>
          </div>
