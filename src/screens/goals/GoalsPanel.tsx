...
/**
 * The Goals surface itself: empty state + one-tap suggested goal + form; goal card with progress, pace,
 * on-track tag. Rendered by both the /goals route and zone B of /profile — one implementation, one save
 * flow. Screen chrome (back link, headline) belongs to the route, not to this panel.
 */
